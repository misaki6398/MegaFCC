...
namespace MegaTFLT.Models.Edq.Models
{
    public class GoodsResponseModel
    {
        ...
        [JsonPropertyName("Details Of Goods")]
        ...
        [JsonPropertyName("Import Country")]
        public string ImportCountry { get; set; }

        [JsonPropertyName("Export Country")]
        ...
        [JsonPropertyName("Import Country from")]
        public string ImportCountryFrom { get; set; }

        [JsonPropertyName("Export Country to")]
